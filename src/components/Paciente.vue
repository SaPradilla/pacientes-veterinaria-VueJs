...
<template>
    <div class="mx-5 my-10 bg-white/80 shadow-md px-5 py-10 rounded-xl">
        <p class="font-bold mb-3 text-black uppercase">ID:
            <span class="font-normal normal-case">
            {{ paciente.id }}
            </span>
        </p>

        <p class="font-bold mb-3 text-black uppercase">Nombre:
            <span class="font-normal normal-case">
            {{ paciente.nombre }}
            </span>
        </p>

        <p class="font-bold mb-3 text-black uppercase">Propietario: 
            <span class="font-normal normal-case">
            {{ paciente.propietario }}
            </span>
        </p>

        <p class="font-bold mb-3 text-black uppercase">Email: 
            <span class="font-normal normal-case">
                {{ paciente.email }}
        ...
        <p class="font-bold mb-3 text-black uppercase">Fecha Alta:
            <span class="font-normal normal-case">
                {{ paciente.alta }}
        ...
        <p class="font-bold mb-3 text-black uppercase">Síntomas:
            <span class="font-normal normal-case">
                {{ paciente.sintomas }}
